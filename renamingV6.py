...
class FileRenamerMover:
    def __init__(self, file_mapping, source_directory, additional_info):
        ...
        self.folder1 = os.path.join(self.base_destination_directory, 'folder1')
        self.folder2 = os.path.join(self.base_destination_directory, 'folder2')
        self.folder3 = os.path.join(self.base_destination_directory, 'folder3')
    ...
    def determine_destination_folder(self, new_name):
        ...
        if new_name.startswith('P&L_CONSOLIDATED_'):
            ...
            return self.folder2
        elif new_name.startswith('Balancesheet_consolidated'):
            return self.folder3
        else:
            return self.folder3
